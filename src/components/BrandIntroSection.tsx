...
const BrandIntroSection = () => {
  return (
    <section id="brand-intro" className="brand-intro py-32 bg-white scroll-reveal">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-8 -right-8 w-36 h-36 bg-gold flex items-center justify-center shadow-xl">
