...
const BrandIntroSection = () => {
  return (
    <section id="brand-intro" className="section-seamless bg-white py-16 md:py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="space-y-6 md:space-y-8">
            <h2 className="text-heading-2 text-gray-900 tracking-tight uppercase leading-tight">
              must have: <span className="text-gold lowercase font-serif font-bold">extendable sofa</span>
            </h2>
            <p className="text-body-large text-gray-600 leading-relaxed font-light italic">
